package com.bn.game.chap11.ex7;
...
public class MyGLView extends GLSurfaceView{
	...
	private class SceneRenderer implements GLSurfaceView.Renderer {
		...
		public void onDrawFrame(GL10 gl) {
            ...
            gl.glTranslatef(0, 0f, -1.9f);//不合理视角  
//            gl.glTranslatef(0, 0f, -6f);//合理视角
            cube.drawSelf(gl);
		}
		@Override
		public void onSurfaceChanged(GL10 gl, int width, int height) {           
            ...
            gl.glFrustumf(-ratio, ratio, -1, 1, 0.4f, 10);//调用此方法计算产生透视投影矩阵，不合理的视角
//            gl.glFrustumf(-ratio, ratio, -1, 1, 2.0f, 10);//调用此方法计算产生透视投影矩阵，合理的视角
		}
		@Override
	...
	public int initTexture(GL10 gl,int drawableId){
		...
		gl.glTexParameterf(GL10.GL_TEXTURE_2D,
				GL10.GL_TEXTURE_MAG_FILTER, GL10.GL_LINEAR_MIPMAP_LINEAR);
		//生成MIPMAP纹理
