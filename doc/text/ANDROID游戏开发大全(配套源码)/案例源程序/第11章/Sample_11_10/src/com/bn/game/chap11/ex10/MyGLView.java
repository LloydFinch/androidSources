...
public class MyGLView extends GLSurfaceView{
	...
	float angdegZ=0;//灯在xz面上的投影与z轴的夹角
	float rLight=10;
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            renderer.regularPyramid.yAngle += dx * TOUCH_SCALE_FACTOR;//设置沿y轴旋转角度
            renderer.regularPyramid.xAngle+= dy * TOUCH_SCALE_FACTOR;//设置沿x轴旋转角度
            requestRender();//重绘画面
        }
        previousY = y;//记录触控笔位置
        previousX = x;//记录触控笔位置
...
//            		1};
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {            
            ...
            regularPyramid=new RegularPyramid(1.5f,0.4f,1.2f,60,
            		bottomTexId,sideTexId);
		}		
	}//SceneRenderer
	//初始化纹理
