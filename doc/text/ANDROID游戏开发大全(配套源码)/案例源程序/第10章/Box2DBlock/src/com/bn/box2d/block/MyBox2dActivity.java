...
{   
    ...
    {   
        ...
        MyRectColor mrc=Box2DUtil.createBox(kd/2, SCREEN_HEIGHT/2, kd/2, SCREEN_HEIGHT/2, true,world,Color.YELLOW);
        bl.add(mrc);
        mrc=Box2DUtil.createBox(SCREEN_WIDTH-kd/2, SCREEN_HEIGHT/2, kd/2, SCREEN_HEIGHT/2, true,world,Color.YELLOW);
        bl.add(mrc);
        mrc=Box2DUtil.createBox(SCREEN_WIDTH/2, kd/2, SCREEN_WIDTH/2, kd/2, true,world,Color.YELLOW);
        bl.add(mrc);
        mrc=Box2DUtil.createBox(SCREEN_WIDTH/2, SCREEN_HEIGHT-kd/2, SCREEN_WIDTH/2, kd/2, true,world,Color.YELLOW);
        bl.add(mrc);
