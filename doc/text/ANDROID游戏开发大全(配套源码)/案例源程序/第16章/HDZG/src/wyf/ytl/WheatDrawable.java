...
public class WheatDrawable extends MyMeetableDrawable implements Serializable{
	...
	public WheatDrawable(){}
		
	public WheatDrawable(Bitmap bmpSelf,Bitmap bmpDialogBack,Bitmap bmpDialogButton,boolean meetable,int width,int height,int col,int row,
